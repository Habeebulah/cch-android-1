...
public class CCHCourseIndexActivity extends Activity implements OnSharedPreferenceChangeListener {

	public static final String TAG = CCHCourseIndexActivity.class.getSimpleName();
